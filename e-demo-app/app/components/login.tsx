...
export default function Login() {
    return (
        <div className={`${style.Login}`}>
            <div className="flex bg-slate-100  p-4 rounded-[10] flex-col shadow-sm pt-8 items-center justify-center">
                <h1 className='font-bold text-2xl font-[Times]'>Conecte-se ou Registe-se</h1>
                <div className='pt-8'>
                    <h1>Email address</h1>
                    <form action="">
                        ...
                        <div className='flex flex-col  p-1 font-bold text-sm '>
                            ...
                            <div className='flex  justify-between  m-1 p-2 bg-slate-50 rounded-[15] shadow-sm '>
                                <div className='bi bi-apple '></div>
                                <h1 className='pr-2 self-center'>Entrar com Apple</h1>
                            </div>
                            <div className='flex justify-between m-1 p-2 bg-slate-50 rounded-[15] shadow-sm '>
                                <div className='bi bi-twitter-x  '></div>
